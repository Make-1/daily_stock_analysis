...
import { BarChart3, BriefcaseBusiness, Globe2, Home, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'us-screener', label: '美股筛选', to: '/us-screener', icon: Globe2 },
