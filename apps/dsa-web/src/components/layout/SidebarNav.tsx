...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Globe2, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'us-screener', labelKey: 'layout.nav.usScreener', to: '/us-screener', icon: Globe2 },
